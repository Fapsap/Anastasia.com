...
function btn_send_q() {
	...
	setCookie('sndform', 'true', {expires: Date('2030-12-17T03:24:00')});
	localStorage.setItem('sndform', 'true');
	document.getElementById('form_btn').setAttribute("disabled", "");
}

function btn_send(){
	if (getCookie('sndform') == 'true' || localStorage.sndform == 'true'){
